...
\begin{document}
	...
	\subsection{Code thực tế: Tách Features và Target}
	...
	\subsection{Code thực tế: One-Hot Encoding}
	...
	\subsection{Code thực tế: Train-Test Split}
	...
	\section{Hàm đánh giá mô hình}
	
	\subsection{Code thực tế: Hàm evaluate\_model()}
	...
	\subsection{Code thực tế: Linear Regression}
	...
	\subsection{Code thực tế: XGBoost}
	...
	\subsection{Code thực tế: Trích xuất và Hiển thị Độ Quan Trọng}
	...
	\begin{verbatim}
		...
		for idx, row in top_5.iterrows():
		    ...
		    print(f"{row['feature']:30s} {row['importance']:8.4f} ({percentage:5.1f}%)")
